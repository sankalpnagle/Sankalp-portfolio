...
export function Sidebar({ active, onNav }: SidebarProps) {
  return (
    <aside
      id="sidebar"
      className="fixed left-0 top-0 bottom-0 flex flex-col overflow-hidden z-[200] px-9 pt-[44px] pb-9 max-[1024px]:hidden"
      style={{
    ...
    >
      ...
      >
        <p
          className="cond text-[36px] font-black text-white leading-none"
          style={{ letterSpacing: "var(--letter-spacing-tight1)" }}
        >
          SANKALP
        </p>
        <p
          className="cond text-[36px] font-black leading-none mb-[10px]"
          style={{
        ...
        <div
          className="w-9 h-[2px] mt-[14px] rounded-[1px]"
