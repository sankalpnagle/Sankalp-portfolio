import type { NavItem, SkillData, Experience, Project, ContactInfo, StatBox } from '@/types'
...
export const TECH: string[] = [
  ...
  'MongoDB', 'MySQL', 'Prisma', 'AWS', 'Firebase', 'Redux Toolkit',
  'Tailwind CSS', 'GitHub Actions', 'JWT', 'OAuth', 'REST APIs', 'Cursor AI',
]
...
export const CONTACT_INFO: ContactInfo[] = [
  { ico: '✉', l: 'Email', v: 'sankalp.nagle07@gmail.com', h: 'mailto:sankalp.nagle07@gmail.com' },
